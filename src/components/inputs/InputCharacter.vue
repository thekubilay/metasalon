    ...
    <div class="chara-container">
        ...
        <swiper
            ...
            <swiper-slide v-for="(char, idx) in props.characters" :key="idx" >
                <p class="char"
                    :style="{backgroundImage: 'url(/images/characters/' + char.split('.')[0].split('/')[1] + '.png)', backgroundSize: 'cover'}"
                    :class="{active:props.modelValue['character'].value===char, disabled:!['models/soldier.glb'].includes(char)}"
